...
void mdCommand::set(const string &currentValString) {
    ...
    //TODO: if string is number, get value and check against MD_BYTE/MD_WORD range
...
void mdCommand::setDefault(const string &param) {
    ...
    if (paramType == MD_BOOL && mdCmdType != MD_BOOL) throw (string("Non-Boolean default parameter specified for MD_BOOL command"));
